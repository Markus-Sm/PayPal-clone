...
if(window.innerWidth < 1000){
	...
	dropdownItems.forEach(dropdownItems => {
		dropdownItems.addEventListener('mouseover', () => {
			...
			dropdownItems.firstElementChild.firstElementChild.style.transform = "rotate(180deg)"
		})
		...
		dropdownItems.addEventListener('mouseout', () => {
			...
			dropdownItems.firstElementChild.firstElementChild.style.transform = "rotate(0)"
		})
	})
	
	const navDropdownItem = document.querySelectorAll('.nav-dropdown-item')
	
	navDropdownItem.forEach(navDropdownItem => {
		navDropdownItem.addEventListener('mouseover', () => {
			navDropdownItem.lastElementChild.style.cssText = 'text-decoration: underline'
			navDropdownItem.firstElementChild.style.cssText = 'text-decoration: underline'
		})
	
		navDropdownItem.addEventListener('mouseout', () => {
			navDropdownItem.lastElementChild.style.cssText = 'text-decoration: none'
			navDropdownItem.firstElementChild.style.cssText = 'text-decoration: none'
		})
	})
}
